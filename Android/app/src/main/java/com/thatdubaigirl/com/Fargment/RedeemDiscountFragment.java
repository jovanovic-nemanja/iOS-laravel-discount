...
public class RedeemDiscountFragment extends Fragment {
    CircleImageView ivprofile;
    ImageView ivimage;
    TextView txtusername, txtmembernumber, txttitle;
    EditText edpincode;
    Button btnredeemsubmit;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_redeem_discount, container, false);
...
//        categori_model = (Categori_Model) getIntent().getSerializableExtra("data");
        ...
        nestedScrollView=v.findViewById(R.id.redeemscrollview);
